...
/**
 * A Com_dataunacquiring.
 */
@Entity
@Table(name = "com_dataunacquiring")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Com_dataunacquiring implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Com_dataunacquiring com_dataunacquiring = (Com_dataunacquiring) o;
        if(com_dataunacquiring.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, com_dataunacquiring.id);
    }
