 ...
 */
@Entity
@Table(name = "com_payer")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Com_payer implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Com_payer com_payer = (Com_payer) o;
        if(com_payer.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, com_payer.id);
    }
