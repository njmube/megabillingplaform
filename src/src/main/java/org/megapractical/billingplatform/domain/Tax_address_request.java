...
/**
 * A Tax_address_request.
 */
@Entity
@Table(name = "tax_address_request")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Tax_address_request implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Tax_address_request tax_address_request = (Tax_address_request) o;
        if(tax_address_request.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, tax_address_request.id);
    }
