...
/**
 * A Freecom_destruction_certificate.
 */
@Entity
@Table(name = "freecom_destruction_certificate")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Freecom_destruction_certificate implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Freecom_destruction_certificate freecom_destruction_certificate = (Freecom_destruction_certificate) o;
        if(freecom_destruction_certificate.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, freecom_destruction_certificate.id);
    }
