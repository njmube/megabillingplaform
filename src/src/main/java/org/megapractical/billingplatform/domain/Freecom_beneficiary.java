...
/**
 * A Freecom_beneficiary.
 */
@Entity
@Table(name = "freecom_beneficiary")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Freecom_beneficiary implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Freecom_beneficiary freecom_beneficiary = (Freecom_beneficiary) o;
        if(freecom_beneficiary.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, freecom_beneficiary.id);
    }
