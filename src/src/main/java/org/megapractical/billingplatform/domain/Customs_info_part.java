 ...
 */
@Entity
@Table(name = "customs_info_part")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Customs_info_part implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Customs_info_part customs_info_part = (Customs_info_part) o;
        if(customs_info_part.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, customs_info_part.id);
    }
