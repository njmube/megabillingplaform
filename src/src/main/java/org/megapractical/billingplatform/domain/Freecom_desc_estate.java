...
/**
 * A Freecom_desc_estate.
 */
@Entity
@Table(name = "freecom_desc_estate")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Freecom_desc_estate implements Serializable {
    ...
    public C_type_estate getC_type_estate() {
        return c_type_estate;
    }

    public void setC_type_estate(C_type_estate c_type_estate) {
        this.c_type_estate = c_type_estate;
    }
    ...
    public boolean equals(Object o) {
        ...
        Freecom_desc_estate freecom_desc_estate = (Freecom_desc_estate) o;
        if(freecom_desc_estate.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, freecom_desc_estate.id);
    }
