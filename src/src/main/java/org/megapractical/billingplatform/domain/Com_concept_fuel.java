 ...
 */
@Entity
@Table(name = "com_concept_fuel")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Com_concept_fuel implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Com_concept_fuel com_concept_fuel = (Com_concept_fuel) o;
        if(com_concept_fuel.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, com_concept_fuel.id);
    }
