...
/**
 * A Freecom_paybill_concept.
 */
@Entity
@Table(name = "freecom_paybill_concept")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Freecom_paybill_concept implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Freecom_paybill_concept freecom_paybill_concept = (Freecom_paybill_concept) o;
        if(freecom_paybill_concept.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, freecom_paybill_concept.id);
    }
