 ...
 */
@Entity
@Table(name = "com_desc_estate")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Com_desc_estate implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Com_desc_estate com_desc_estate = (Com_desc_estate) o;
        if(com_desc_estate.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, com_desc_estate.id);
    }
