 ...
 */
@Entity
@Table(name = "com_addressee")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class Com_addressee implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        Com_addressee com_addressee = (Com_addressee) o;
        if(com_addressee.id == null || id == null) {
            return false;
        }
        return Objects.equals(id, com_addressee.id);
    }
