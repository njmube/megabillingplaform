...
public class Tax_conceptResource {
    ...
    @Timed
    public ResponseEntity<Tax_concept> createTax_concept(@RequestBody Tax_concept tax_concept) throws URISyntaxException {
    ...
    @RequestMapping(value = "/tax-concepts",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Tax_concept> updateTax_concept(@RequestBody Tax_concept tax_concept) throws URISyntaxException {
    ...
    public ResponseEntity<List<Tax_concept>> getAllTax_concepts(Pageable pageable)
        ...
        Page<Tax_concept> page = tax_conceptService.findAll(pageable); 
