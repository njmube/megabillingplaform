(function() {
    ...
    Freecom_specific_descriptionsDetailController.$inject = ['$scope', '$rootScope', '$stateParams', 'entity', 'Freecom_specific_descriptions'];

    function Freecom_specific_descriptionsDetailController($scope, $rootScope, $stateParams, entity, Freecom_specific_descriptions) {
        var vm = this;
