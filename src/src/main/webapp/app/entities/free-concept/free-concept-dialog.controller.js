(function() {
    ...
    Free_conceptDialogController.$inject = ['$scope', '$stateParams', '$uibModalInstance', 'entity', 'Free_concept', 'Free_cfdi', 'Measure_unit', 'Tax_transfered', 'Tax_retentions'];

    function Free_conceptDialogController ($scope, $stateParams, $uibModalInstance, entity, Free_concept, Free_cfdi, Measure_unit, Tax_transfered, Tax_retentions) {
        var vm = this;
        ...
        vm.tax_retentionss = Tax_retentions.query();
        vm.load = function(id) {
