        ...
        var onLocalTaxesSaveSucccess = function(result){
            ...
            for(i = 0; i < vm.freecom_ret_transfs.length; i++){
                ...
                if(vm.freecom_ret_transfs[i].transfered != null) {
                    ...
                    Freecom_retentions_transfered.save(transfered);
                }
            }
