(function() {
    ...
    Part_conceptDialogController.$inject = ['$uibModalInstance', 'entity', 'Measure_unit'];

    function Part_conceptDialogController ($uibModalInstance, entity, Measure_unit) {
        var vm = this;
        ...
        function calcAmount(){
            ...
            if(vm.part_concept.quanitty > 0 && vm.part_concept.unit_value > 0 && part_concept_unit_value.match(regexp)){
                ...
                var amount = bln.multiply(vm.part_concept.quanitty, vm.part_concept.unit_value, 6);
