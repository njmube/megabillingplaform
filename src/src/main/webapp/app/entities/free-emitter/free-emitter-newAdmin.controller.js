(function() {
    ...
    angular
        ...
        .controller('Free_emitterNewAdminController', Free_emitterNewAdminController);

    Free_emitterNewAdminController.$inject = ['$scope', 'Principal', '$stateParams', '$uibModal', '$q', 'entity', 'DataUtils', 'Free_emitter_file','Free_emitter', 'Tax_regime', 'C_country', 'C_state', 'C_municipality', 'C_colony', 'C_zip_code','Type_taxpayer'];

    function Free_emitterNewAdminController ($scope, Principal, $stateParams, $uibModal, $q, entity, DataUtils, Free_emitter_file, Free_emitter, Tax_regime, C_country, C_state, C_municipality, C_colony, C_zip_code, Type_taxpayer) {
        var vm = this;
