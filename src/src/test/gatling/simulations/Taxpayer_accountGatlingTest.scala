...
class Taxpayer_accountGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Taxpayer_account entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "rfc":"SAMPLE_TEXT", "bussines_name":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "fax":"SAMPLE_TEXT", "phone1":"SAMPLE_TEXT", "phone2":"SAMPLE_TEXT", "accuracy":"0"}""")).asJSON
            .check(status.is(201))
