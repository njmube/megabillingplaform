...
/**
 * Performance test for the General_data entity.
 */
class General_dataGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the General_data entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all general_data")
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created general_data")
                .get("${new_general_data_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created general_data")
            .delete("${new_general_data_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
