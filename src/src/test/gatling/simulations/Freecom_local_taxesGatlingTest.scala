...
/**
 * Performance test for the Freecom_local_taxes entity.
 */
class Freecom_local_taxesGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Freecom_local_taxes entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all freecom_local_taxes")
            .get("/api/freecom-local-taxes")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created freecom_local_taxes")
                .get("${new_freecom_local_taxes_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created freecom_local_taxes")
            .delete("${new_freecom_local_taxes_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
