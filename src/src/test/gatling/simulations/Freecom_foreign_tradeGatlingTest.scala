...
/**
 * Performance test for the Freecom_foreign_trade entity.
 */
class Freecom_foreign_tradeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Freecom_foreign_trade entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all freecom_foreign_trades")
            .get("/api/freecom-foreign-trades")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created freecom_foreign_trade")
                .get("${new_freecom_foreign_trade_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created freecom_foreign_trade")
            .delete("${new_freecom_foreign_trade_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
