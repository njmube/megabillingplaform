...
/**
 * Performance test for the C_colony entity.
 */
class C_colonyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the C_colony entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created c_colony")
                .get("${new_c_colony_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created c_colony")
            .delete("${new_c_colony_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
