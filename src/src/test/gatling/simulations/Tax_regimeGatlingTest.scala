...
/**
 * Performance test for the Tax_regime entity.
 */
class Tax_regimeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Tax_regime entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created tax_regime")
                .get("${new_tax_regime_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created tax_regime")
            .delete("${new_tax_regime_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
