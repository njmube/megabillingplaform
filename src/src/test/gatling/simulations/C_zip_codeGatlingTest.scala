...
/**
 * Performance test for the C_zip_code entity.
 */
class C_zip_codeGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the C_zip_code entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created c_zip_code")
                .get("${new_c_zip_code_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created c_zip_code")
            .delete("${new_c_zip_code_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
